...
const Hero = () => {
  ...
  const countryCodes = [
    ...
    { value: "+1", label: "+1 (US)" },
    { value: "+44", label: "+44 (GB UK)" },
    { value: "+61", label: "+61 (AU AUS)" },
    { value: "+81", label: "+81 (JP)" },
    { value: "+971", label: "+971 (AE UAE)" },
                ...
                {selectedFiles.length > 0 && (
                  <div className="mt-2 space-y-2">
                    {selectedFiles.map((file, index) => (
                      <div key={index} className="flex items-center justify-between bg-gray-50 p-2 rounded text-sm border">
